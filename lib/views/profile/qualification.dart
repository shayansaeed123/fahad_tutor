...
@override
  void initState() {
    ...
    repository.fetchData('Qualification','Qualification', newItemsQualification1, selectedIdsQualification1, updateSelectedNamesQualification1,(val)=> setState(() {isLoading = val;}));
    ...
    repository.fetchData('Qualification','Qualification', newItemsQualification2, selectedIdsQualification2, updateSelectedNamesQualification2,(val)=> setState(() {isLoading = val;}));
    ...
    repository.fetchData('Qualification','Qualification', newItemsQualification3, selectedIdsQualification3, updateSelectedNamesQualification3,(val)=> setState(() {isLoading = val;}));
  ...
  if (selectedNamesinstitute1.isNotEmpty &&
      selectedIdsQualification1.isNotEmpty) {
    updateStatus();
  } else {
    Utils.snakbar(
      context,
      selectedNamesinstitute1.isEmpty
  ...
  Future<void> updateStatus() async {
    ...
    try {
      ...
      Map<String, String> body = {
        ...
        'Institute1': institudejson1,
        'Degree2': qualificationjson2,
        'Institute2': institudejson2,
        'Degree3': qualificationjson3,
        'Institute3': institudejson3,
      };
      ...
      if (response.body.isNotEmpty) {
        final Map<String, dynamic> jsonResponse = json.decode(response.body);
          ...
          selectedIdsinstitute1 = (jsonResponse['Institute_listing'] as List)
              ...
              .toList();
          selectedIdsQualification1 = (jsonResponse['Institute_Qualification'] as List)
              .map<Map<String, String>>((item) => {'id': item['id'].toString()})
              .toList();
          ...
          selectedIdsinstitute2 = (jsonResponse['Institute_listing'] as List)
              .map<Map<String, String>>((item) => {'id': item['id'].toString()})
              .toList();
          selectedIdsQualification2 = (jsonResponse['Institute_Qualification'] as List)
              .map<Map<String, String>>((item) => {'id': item['id'].toString()})
              .toList();
          ...
          selectedIdsinstitute3 = (jsonResponse['Institute_listing'] as List)
              .map<Map<String, String>>((item) => {'id': item['id'].toString()})
              .toList();
          selectedIdsQualification3 = (jsonResponse['Institute_Qualification'] as List)
              .map<Map<String, String>>((item) => {'id': item['id'].toString()})
              .toList();    
      ...
      style: TextStyle(
        ...
        fontFamily: 'tutorPhi'
              ...
              if(value == 1){
                return reusableVisiblityMesage(context, MySharedPrefrence().get_popup_text(), (){setState(() {visible=false;});}, visible);
                  ...
                  reusablequlification(context, 'Qualification', () {
                    repository.search(context, newItemsQualification1, selectedIdsQualification1, 'degree_title',toggleSelection);
                  }),
                  reusablaSizaBox(context, .020),
                  Container(
                    constraints: BoxConstraints(maxHeight: MediaQuery.of(context).size.height * 0.3),
                  ...
                  reusablaSizaBox(context, 0.020),
                  reusableDocuments1(context, '', 'Proof', state.profile != null
              ? state.profile!.path
              : repository.profile_image.value.toString(),
                  ...
                  reusablaSizaBox(context, .020),
                  reusablequlification(context, 'Qualification', () {
                    repository.search(context, newItemsQualification2, selectedIdsQualification2, 'degree_title',toggleSelection);
                  }),
                  reusablaSizaBox(context, .020),
                  Container(
                    constraints: BoxConstraints(maxHeight: MediaQuery.of(context).size.height * 0.3),
              ...
              : repository.profile_image.value.toString(),
                  ...
                  reusablaSizaBox(context, .020),
                  reusablequlification(context, 'Qualification', () {
                    repository.search(context, newItemsQualification3, selectedIdsQualification3, 'degree_title',toggleSelection);
                  }),
                  reusablaSizaBox(context, .020),
                  Container(
                    constraints: BoxConstraints(maxHeight: MediaQuery.of(context).size.height * 0.3),
